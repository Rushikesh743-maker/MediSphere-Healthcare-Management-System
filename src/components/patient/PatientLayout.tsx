...
const navItems: { to: string; label: string; icon: any; exact?: boolean }[] = [
  ...
  { to: "/patient/request-appointment", label: "Request Appointment", icon: CalendarPlus },
  ...
  { to: "/patient/lab-reports", label: "Laboratory Reports", icon: FlaskConical },
    ...
    <div className="min-h-screen bg-slate-50 flex" style={{ fontFamily: "Inter, sans-serif" }}>
      ...
      >
        <div className="flex items-center justify-between px-5 py-4 border-b border-slate-200">
          <Link to="/patient" className="flex items-center gap-2 text-blue-600 font-semibold">
