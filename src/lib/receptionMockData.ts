...
export const doctorsList: ReceptionDoctor[] = [
  { id: "D01", name: "Dr.Ruhikesh N", department: "General Medicine", status: "Available" },
...
export const initialAppointmentRequests: AppointmentRequest[] = [
  {
    ...
    preferredDoctor: "Dr.Ruhikesh N",
    preferredDate: "2026-07-21",
    reason: "Diabetes follow-up",
    priority: "Normal",
    status: "Confirmed",
    assignedDoctor: "Dr.Ruhikesh N",
...
export const initialQueue: QueueEntry[] = [
  { id: "Q1", token: 1, patientName: "Rohan Patel", doctor: "Dr.Ruhikesh N", time: "09:30", status: "In Consultation" },
